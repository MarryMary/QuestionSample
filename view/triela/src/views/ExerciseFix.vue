...
export default {
  ...
  methods: {
    ...
    sendEnter(){
      axios.post(
          'http://localhost:8080/FixExercise',
          {
            Id: this.dataid,
  ...
  mounted: function() {
    axios.post(
        ...
        function(response){
          ...
          this.dumper.main_title = exercise.ExName
          this.dumper.detail = exercise.ExDetail
          this.dumper.tag = exercise.ExTags
          this.dumper.time_limit = exercise.ExTimeUp
